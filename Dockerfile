...
ARG PHP_EXT_ESSENTIAL="bcmath opcache mysqli pdo_mysql bz2 soap sockets zip gd intl yaml apcu grpc protobuf memcached redis xhprof"

# Default PHP version
ARG BUILD_FRANKENPHP_VER="1.4.0"
...
RUN install-php-extensions ${PHP_EXT_ESSENTIAL} xdebug
RUN docker-php-ext-enable ${PHP_EXT_ESSENTIAL}
